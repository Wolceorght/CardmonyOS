<script setup>
  ...
  onMounted(() => {
    //强制加载 canvas 使用的字体
    const nameFont = new FontFace("AR LisuGB Medium", "url(/CardmonyOS/font/ARLisuGB-Medium.woff2)");
    const textFont = new FontFace("BlizzardGlobal", "url(/CardmonyOS/font/BlizzardGlobal.woff2)");
